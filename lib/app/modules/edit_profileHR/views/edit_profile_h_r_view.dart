...
class EditProfileHRView extends GetView<EditProfileHRController> {
  ...
  final GlobalKey<FormState> _nama = GlobalKey<FormState>();
  final GlobalKey<FormState> _divisi = GlobalKey<FormState>();
  @override
        ...
        body: FutureBuilder<DocumentSnapshot<Object?>>(
          ...
          builder: (context, snap) {
            ...
            if (snap.hasData) {
              ...
              var nama = controller.nameC.text = data['name'];
              var divisi = controller.divisiC.text = data['divisi'];
